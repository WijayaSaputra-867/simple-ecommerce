...
- **Low Stock Alert (Queue)**: Automatically dispatches `LowStockAlertJob` when a product’s stock drops below **5**.
...
### Terminal 1 – Laravel Server & Frontend (Vite)
